            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              >
                <SelectTrigger className="w-[120px] h-8">
                  ...
                  <SelectValue placeholder={t('batch.category')} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">{t('batch.noCategory')}</SelectItem>
                  {categories.map((cat) => (
              ...
              >
                <SelectTrigger className="w-[120px] h-8">
                  ...
                  <SelectValue placeholder={t('batch.level')} />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="none">{t('batch.noLevel')}</SelectItem>
                  {levels.map((level) => (
      ...
      <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            >
              {isProcessing ? t('batch.deleting') : t('common.confirm')}
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
