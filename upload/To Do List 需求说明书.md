...
- **时间记录** ✅：记录工作活动的时间投入（开始时间、结束时间）
- **任务关联** ✅：时间记录可关联具体任务，统计任务耗时
- **分类支持** ✅：时间记录可关联分类，按分类统计时间分布
- **日统计** ✅：显示当日总时长、任务时间、其他时间
- **简洁UI** ✅：单行统计 + 扁平列表布局，清爽风格

#### 任务预计耗时 ✅ 已完成

- **预计耗时字段** ✅：任务可设置预计耗时（分钟），用于区分"跨天工作"和"长截止期短耗时"
- **时间选项** ✅：预设选项（15分钟、1小时、2小时、4小时、8小时、2天、1周、1月、1季度、半年）
- **跨天横跨框阈值** ✅：预计耗时 >= 1天（480分钟）的任务在日历/周视图显示横跨框
